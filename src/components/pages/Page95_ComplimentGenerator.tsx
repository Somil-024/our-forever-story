      ...
      <motion.div className="relative z-10 text-center max-w-2xl mx-auto"
        ...
        <motion.div className="glass-card rounded-3xl p-8 md:p-12 mb-12"
          ...
          <button
            ...
            className="w-full px-8 py-6 bg-gradient-to-r from-blush to-love-red rounded-full font-display text-xl text-white hover:shadow-glow transition-all transform hover:scale-105 active:scale-95 mb-8">
            Compliment do 💕
          </button>
          ...
          {showCompliment && (
            <motion.div
              ...
              className="p-6 bg-gradient-to-r from-blush/20 to-love-red/20 rounded-2xl">
